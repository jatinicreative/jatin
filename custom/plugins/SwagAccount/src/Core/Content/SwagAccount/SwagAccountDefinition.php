...
use SwagAccount\Core\Content\SwagAccount\Aggregate\SwagAccountTranslationDefinition;
...
class SwagAccountDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            new FkField('image_id','imageId',MediaDefinition::class,'id'),
            ...
            new OneToOneAssociationField('media','image_id', 'id',MediaDefinition::class,true),
